...
// GET /api/assistant-configs/[id] - Obtener configuración por ID
export async function GET(
  ...
  try {
    ...
    try {
      const backendResponse = await fetch(`${API_BASE_URL}/assistant-configs/${params.id}`, {
        method: 'GET',
        headers: {
    ...
    console.error('Error en /api/assistant-configs/[id] GET:', error);
    return new NextResponse('Error interno del servidor', { status: 500 });
  }
}

// PATCH /api/assistant-configs/[id] - Actualizar configuración
export async function PATCH(
  ...
  try {
    ...
    console.error('Error en /api/assistant-configs/[id] PATCH:', error);
    return new NextResponse('Error interno del servidor', { status: 500 });
  }
}

// DELETE /api/assistant-configs/[id] - Eliminar configuración
export async function DELETE(
  ...
  try {
    ...
    console.error('Error en /api/assistant-configs/[id] DELETE:', error);
    return new NextResponse('Error interno del servidor', { status: 500 });
  }
}
